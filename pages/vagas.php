    ...
    <div class="container ps-lg-5">
        <div class="row w-100 ps-lg-5">
            <div class="title-banner col-lg-1 col-4 ms-3">
                <h1 class="text-white text-uppercase" data-aos="fade-right" data-aos-duration="1200">Vagas</h1>
                <span>Vagas</span>
            </div>
            <div class="text-banner pe-4 pt-3 ms-3">
                <p class="text-white pe-5 pb-lg-5 mb-lg-5" data-aos="fade-left" data-aos-duration="1200">
                    Se você tem espírito empreendedor e gosta de ampliar horizontes, inscreva-se para as vagas ou deixe seu currículo.
                </p>
            </div>
            <form class="filter-banner bg-light col-lg-9 col-7 mt-lg-5 mt-3 ms-3 ms-lg-auto me-lg-5 px-3 py-2" data-aos="fade-left" data-aos-duration="1500">
...
<section id="vagas" class="container py-5 mt-5 px-0">
    <div class="row w-100 mx-0">
        <div class="col-lg-4 col vaga mb-lg-0 mb-5 pb-lg-5 px-lg-5 px-4 border-end border-secondary" data-aos="fade-up" data-aos-duration="1200">
            <div class="mb-4">
        ...
        <div class="col-lg-4 col vaga mb-lg-0 mb-5 pb-lg-5 px-lg-5 px-4" data-aos="fade-up" data-aos-duration="1500">
            <div class="mb-4">
                <h2 class="text-center rounded-pill text-white text-uppercase fw-light bg-secondary h6 mb-0 py-2">Área de atuação | SP | Presencial</h2>
            </div>
            <h1 class="text-primary fw-bold mb-3">Título da Vaga</h1>
        ...
        <div class="col-lg-4 col vaga mb-lg-0 mb-5 pb-lg-5 px-lg-5 px-4 border-end border-secondary" data-aos="fade-up" data-aos-duration="1500">
            <div class="mb-4">
                <h2 class="text-center rounded-pill text-white text-uppercase fw-light bg-secondary h6 mb-0 py-2">Área de atuação | SP | Presencial</h2>
            </div>
            <h1 class="text-primary fw-bold mb-3">Título da Vaga</h1>
        ...
        <div class="col-lg-4 col vaga mb-lg-0 mb-5 pb-lg-5 px-lg-5 px-4 border-end border-secondary" data-aos="fade-up" data-aos-duration="1800">
            <div class="mb-4">
                <h2 class="text-center rounded-pill text-white text-uppercase fw-light bg-secondary h6 mb-0 py-2">Área de atuação | SP | Presencial</h2>
            </div>
            <h1 class="text-primary fw-bold mb-3">Título da Vaga</h1>
        ...
        <div class="col-lg-4 col vaga mb-lg-0 mb-5 pb-lg-5 px-lg-5 px-4" data-aos="fade-up" data-aos-duration="1800">
            <div class="mb-4">
                <h2 class="text-center rounded-pill text-white text-uppercase fw-light bg-secondary h6 mb-0 py-2">Área de atuação | SP | Presencial</h2>
            </div>
            <h1 class="text-primary fw-bold mb-3">Título da Vaga</h1>
    ...
    <div class="container me-lg-0 pt-lg-0 pt-5 px-0">
        <div class="row align-items-lg-center w-100 mx-0">
            <div class="col-lg-6 col-12 py-lg-5">
                <h1 class="text-primary text-uppercase col-12" data-aos="fade-right" data-aos-duration="1200">Candidate-se</h1>
                <p class="text-primary small col-lg-12 col-9" data-aos="fade-right" data-aos-duration="1500">
                    Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                    officia deserunt mollit anim id est laborum.
                </p>

                <form class="row text-end" data-aos="fade-right" data-aos-duration="1500">
