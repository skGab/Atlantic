...
<!-- ESTUDO -->
<section id="estudo" class="pb-5 position-relative">
    <div class="container px-4 py-5">
        <div class="row pt-5">
...
<!-- THUMB SECAO -->
<section id="thumb-secao" class="d-md-none">
    <div class="container">
...
<!-- CASES -->
<section id="cases_marketfit" class="pb-5 py-md-5">
    <div class="container px-0 text-center d-md-none">
        <h2 class="display-1 nossos_numeros">NOSSOS NUMEROS</h2>
    </div>

    <div class="container px-4 py-5">
        <div class="row align-items-md-center">
            <!-- INFO -->
            <div class="col col-md-12 mb-4 position-relative">
                <h2 class="display-2 d-none d-md-block position-absolute mb-0 start-0 top-0 translate-middle-y nossos_numeros">NOSSOS NUMEROS</h2>
                <!-- MOB -->
                <div class="display-6 mb-5 mb-md-0 d-md-none">
                    São + de
                    <strong class="display-3 fw-bold">100</strong> <br>
                    Empresas que já fizeram o Atlantic MarketFit
                </div>
                <!-- DESK -->
                <div class="fs-5 mb-5 d-none d-md-block">
                    São + de
                    <strong class="display-5 fw-bold">100</strong>
                    Empresas que já fizeram o Atlantic MarketFit
                </div>

                <!-- MOB -->
                <h2 class="display-3 fw-bold d-md-none mb-0">Cases</h2>
                <!-- DESK -->
                <h2 class="cases_bg display-1 position-absolute d-md-none">CASES</h2>
            </div>
    ...
    <div class="container px-4 py-5">
        <div class="row">
            <div class="col text-white text-center">
                <h2 class="h1 d-md-none">CRONOGRAMA</h2>
                <h2 class="h2 d-none d-md-block">CRONOGRAMA</h2>
...
<!-- INVESTIMENTO -->
<section id="investimento" class="position-relative d-md-flex align-items-center">
    ...
    <div class="container px-4 pb-5 pb-md-0">
