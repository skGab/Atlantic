...
<section id="noticias" class="container py-5 mt-5">
    <div class="row justify-content-lg-between w-100 mx-0 mt-lg-5">
        <div class="col-lg-10 col-12 pe-5">
            <h1 class="d-lg-none d-block text-primary fw-normal text-uppercase display-4 mb-3 pe-5">Tag X</h1>
            <h1 class="d-lg-block d-none text-primary fw-normal text-uppercase mb-4">Tag X</h1>
        </div>
