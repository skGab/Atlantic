...
<section id="conteudo" class="container py-5 mt-5">
    <div class="row w-100 mx-0">
        <div class="col-12 d-flex align-items-center w-100 mb-4">
        ...
        <div class="col-12">
            <h1 class="text-primary fw-normal mb-3">
                Portugal, um dos países queridinhos para congressos e convenções
            </h1>
            <img src="../assets/images/img-post1.jpg" class="d-block w-100 mb-3" alt="Capa do Post">
...
<section id="especialitas" class="container-fluid px-0 mt-5">
...
<section id="autor" class="d-block bg-white pt-5 pb-4">
    <div class="container">
        <div class="row w-100 mx-0">
            <div class="col-12">
...
<!-- COMENTÁRIOS -->
<section id="comentarios" class="d-block bg-white pb-5">
    <div class="container">
        <div class="row w-100 mx-0">
            <div class="col-12">
...
<!-- POSTS RELACIONADOS -->
<section id="destaque-artigos" class="d-block bg-white py-5">
