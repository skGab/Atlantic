    ...
    <div class="row justify-content-lg-between w-100 mx-0 mt-lg-5">
        <?php if (have_posts()) : ?>
            ...
            <div class="col-lg-10 col-12 pe-5 mb-4">
                <h1 class="d-lg-none d-block text-primary fw-normal display-4 mb-3 pe-5">Tag - <?php single_tag_title(); ?></h1>
                <h1 class="d-lg-block d-none text-primary fw-normal mb-4">Tag - <?php single_tag_title(); ?></h1>
            </div>
            ...
            <div class="pesquisa col-lg-3 col-12 d-lg-inline d-none">
                ...
                <div id="tags" class="bg-light w-100 rounded-0 border-0 px-4 pt-4 pb-5 mb-5">
                    ...
                    if ($tags) {
                        foreach ($tags as $tag) {
                            echo '<a href="' . get_tag_link($tag->term_id) . '" class="text-primary d-block mb-0">' . $tag->name . '</a>';
                        }
                    }
                    ?>
                </div>
